      ...
      <div className="flex flex-1 justify-between bg-siteblack py-8 sm:px-12 px-8 flex-col">
        ...
        <div className="flex-1 flex justify-center flex-col xl:mt-0 my-16">
          <div className="flex flex-row w-full">
            ...
            <h1 className={`${styles.headText} text-left`}>Welcome to the <br /> Gabriel's~ Web3.0 Game</h1>
          </div>
        ...
        <p className="font-rajdhani font-medium text-base text-white">Made with 💜 by Gabriel Favour</p>
      </div>
